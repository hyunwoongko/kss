...
Table = create_dict(
    {
        Stats.DA_EOJEOL: da_eojeol_dict,
        Stats.DA_MORPH: da_morph_dict,
        Stats.YO: yo_dict,
        Stats.JYO: jyo_dict,
        Stats.SB: sb_dict,
        Stats.EOMI: eomi_dict,
        Stats.COMMON: common_dict,
    },
    default=create_dict({}),
)
